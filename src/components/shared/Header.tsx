...
const Header = () => {
  return (
    <div class='w-full bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 h-16 px-4 flex flex-1 justify-between items-center border-b border-gray-200 dark:border-gray-700'>
       <div class='relative'>
